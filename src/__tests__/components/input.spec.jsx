...
describe("Input Component", () => {
  ...
  //3- Teste unitário O componente Input deve ser renderizado com as propriedades enviadas.
  ...
  //4- Teste unitário. O componente deve trocar a cor da borda ao ser focado.
